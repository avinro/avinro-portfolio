...
- Website: [www.avinro.com](https://www.avinro.com)
...
- Led the definition of core product areas (rides, bookings, availability, and payments), aligning product, engineering, and operations while reducing friction in critical flows.

- Directed the Design System initiative to ensure consistency, scalability, and faster design-to-development workflows.
...
- Lead product definition and design across a multi-product ecosystem: Customer App, Vendor Portal, Driver App, and Fleet Manager.
- Translate business vision into user journeys, system logic, operational flows, and product decisions.
...
- Owned product design for the Baptist Health mobile app, driving UX improvements aligned with activation, retention, and operational efficiency.
- Defined features in collaboration with PMs and engineering, balancing user needs with business and system constraints.
- Designed Smart TV interfaces deployed across hospital environments, optimizing for accessibility, remote interactions, and clarity of information.
- Delivered high-fidelity prototypes and implementation-ready specs to ensure accurate execution.
- Worked closely with data and operations teams to connect UX decisions with measurable outcomes.

### Alyssum Digital — Product Designer

**Nov 2022 – May 2023**

### G Estudios Multimedia — UI/UX & Branding Designer

**May 2022 – Oct 2022**

### Union of Journalists of Cuba — Branding & Motion Designer
...
- UI & Systems
- Web Design & Development with Webflow
- Product Design
