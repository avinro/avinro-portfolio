...
<WorkMetadataGrid>
  ...
  <WorkMetadataCard kind="timeline">
    3 meses (discovery, MVP, refinamiento de producto)
  </WorkMetadataCard>
  ...
  <WorkMetadataCard kind="scope">
    Estrategia de producto, arquitectura UX, sistema de diseño, implementación frontend de
    producción
  </WorkMetadataCard>
  <WorkMetadataCard kind="status">
    Listo para producción, sin financiación (no lanzado)
  </WorkMetadataCard>
</WorkMetadataGrid>
...
<BranchTree
  ...
  hint="Un usuario, cuatro cadencias, una verdad en Supabase"
>
