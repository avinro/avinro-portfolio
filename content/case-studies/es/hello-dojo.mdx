...
>
  <Branch title="Sistema de rideshare" tone="accent">
    ...
    <FlowItem icon="map-pin" label="El sistema muestra conductores disponibles en tiempo real en el mapa" />
  ...
  <Branch title="Reserva de experiencias" tone="accent">
    ...
    <FlowItem icon="layout-grid" label="El sistema muestra locales disponibles que cumplen los criterios" />
  ...
  <Branch title="Sistema de calendario / eventos" tone="accent">
    <FlowItem icon="calendar" label="Todas las reservas (viajes + experiencias) aparecen como eventos" />
    <FlowItem
      icon="alert-triangle"
    ...
    <FlowItem icon="layout-grid" label="Fusiona las tarjetas en una variante Conectada al reservar un viaje" />
  </Branch>
