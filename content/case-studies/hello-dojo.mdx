...
<Bar value={78} label="UI surface area covered by the top 40 components" caption="The remaining 22% consists of surface-specific screens refactored over time as a feature trigger, not a separate design debt sprint." />
...
<BeforeAfter
  label="Driver app — App Store rating"
  from="4.6"
  to="4.8"
  sentiment="positive"
/>
