...
<WorkMetadataGrid>
  ...
  <WorkMetadataCard kind="timeline">3 months (discovery, MVP, product refinement)</WorkMetadataCard>
  ...
  <WorkMetadataCard kind="team">CEO/COO, CTO/CPO, Founding Product Designer (me)</WorkMetadataCard>
...
<BranchTree icon="user" label="Restaurant owner" hint="One user, four cadences, one Supabase truth">
  ...
  <Branch title="Weekly / monthly — Web review" tone="accent">
    ...
    <FlowItem
      icon="bar-chart-3"
      label="Scan KPIs"
      hint="Revenue, expenses, net profit, profitability"
    />
...
**UMA** became a defining moment in how I work as a **Product Designer** with direct ownership of implementation. I owned the **full frontend implementation layer**, combining product thinking, design systems, and **AI-assisted engineering workflows** to ship **production-ready interfaces**.
...
UMA proved that I can operate as a **Product Designer** who owns product strategy, UX architecture, and production implementation in one person.
...
This shift — from Designer who hands off to Code, to Product Designer who owns the continuum from product thinking through shipped pixels — changed how I see my role. UMA was the proof of concept that this way of working actually works at production scale.
