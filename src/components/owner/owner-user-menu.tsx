...
/**
 * Client island: user avatar + dropdown menu for the owner workspace header.
 *
 * Isolated as a small client component so the parent OwnerHeader stays
 * server-rendered. Logout is a native form POST to /auth/signout to avoid
 * importing any server-side auth code.
 *
 * Initials derive from the first two chars of displayName, uppercased.
 */
export function OwnerUserMenu({ displayName, email }: OwnerUserMenuProps) {
